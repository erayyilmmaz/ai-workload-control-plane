...
| `make e2e` | çalıştırılamadı | Yerel Docker daemon socket’i erişilemediği için image build aşamasında durdu; kind cluster oluşturulmadı |

Kind E2E betiği artık tenant Role sınırını, tenant-bravo Secret’ının
