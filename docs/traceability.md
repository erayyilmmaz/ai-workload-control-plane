...
| 07 / AWC-7 | AWCP-8 | Identity, Secret metadata index/watch, RBAC | Unit/envtest missing/restore, later auth/runtime checks | AWCP-6 |
...
| 16 / AWC-16 | AWCP-17 | README/examples, 16-step demo, release preparation | Clean-user demo and release evidence | AWCP-15, 16 |
