...
for file in examples/basic.yaml examples/with-secrets.yaml examples/network-policy.yaml demo/portfolio-demo.sh docs/demo.md docs/release.md docs/verification/AWCP-17.md docs/verification/AWCP-19.md docs/v1-api-evolution.md docs/adr/ADR-009-v1-api-evolution.md docs/adr/ADR-010-optional-platform-capabilities.md test/fixtures/v1/v0-compatible.yaml; do
  test -s "$file"
done
